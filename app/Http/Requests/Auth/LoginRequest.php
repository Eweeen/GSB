...
class LoginRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'VIS_DATEEMBAUCHE' => ['required', 'string'],
        ];
    }
    ...
    public function authenticate()
    {
        ...
        $date = date('Y-m-d H:i:s', strtotime($this->VIS_DATEEMBAUCHE));
        $visiteur = Visiteur::where('VIS_NOM', $this->VIS_NOM)->first();

        if (!$visiteur || $visiteur->VIS_DATEEMBAUCHE !== $date) {
